...
public class AuthService {
        ...
        if (response.getStatusCode() == HttpStatus.OK) {
            ...
            if (responseBody != null && responseBody.get("data") != null) {
                ...
                if (!usersData.isEmpty()) {
                    ...
                    UsuarioDTO usuarioDTO = new ObjectMapper().convertValue(userData, UsuarioDTO.class);

                    // Verificar si el usuario ya existe en la base de datos
                    Optional<Usuario> existingUsuario = usuarioRepository.findByUsuario(usuarioDTO.getUsuario());
                    Usuario usuario;
    ...
    private Usuario convertToEntity(UsuarioDTO usuarioDTO) {
        ...
        usuario.setUpdatedAt(usuarioDTO.getUpdatedAt() != null ? java.sql.Timestamp.valueOf(usuarioDTO.getUpdatedAt()) : null);
