...
public class AuthController {
    ...
    public ResponseEntity<ResponseDto<UsuarioDTO>> register(@RequestBody UsuarioDTO usuarioDTO) {
        ...
        ResponseDto<UsuarioDTO> response = new ResponseDto<>(HttpStatus.OK.value(), resultDTO, "User registered successfully");
    ...
    public ResponseEntity<Map<String, Object>> authenticate(@RequestBody LoginDTO loginDTO) {
        try {
            // Llama al método de autenticación en AuthService que retorna el token y el usuario
    ...
    public ResponseEntity<ResponseDto<Page<UsuarioDTO>>> getAllUsersPaginated(
        ...
        ResponseDto<Page<UsuarioDTO>> response = new ResponseDto<>(HttpStatus.OK.value(), usuarios, "Users fetched successfully");
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<ResponseDto<UsuarioDTO>> changeUserRole(@PathVariable long userId, @PathVariable long roleId) {
        ...
        try {
            ...
            ResponseDto<UsuarioDTO> response = new ResponseDto<>(HttpStatus.OK.value(), updatedUserDto, "Rol de usuario actualizado correctamente");
            return ResponseEntity.ok(response);
        } catch (Exception e) {
    ...
    public ResponseEntity<ResponseDto<UsuarioDTO>> getUserById(@PathVariable long userId) {
        ...
        try {
            ...
            if (userDto != null) {
                ResponseDto<UsuarioDTO> response = new ResponseDto<>(HttpStatus.OK.value(), userDto, "User fetched successfully");
                return ResponseEntity.ok(response);
            } else {
            ...
            ResponseDto<UsuarioDTO> response = new ResponseDto<>(HttpStatus.INTERNAL_SERVER_ERROR.value(), null, "Internal server error");
    ...
    public ResponseEntity<ResponseDto<UsuarioDTO>> editUserProfile(@PathVariable long userId, @RequestBody UsuarioDTO usuarioDTO) {
        ...
        try {
            ...
            ResponseDto<UsuarioDTO> response = new ResponseDto<>(HttpStatus.OK.value(), updatedUserDto, "Perfil de usuario actualizado correctamente");
            return ResponseEntity.ok(response);
        } catch (Exception e) {
    ...
    public ResponseEntity<ResponseDto<List<String>>> getAllDependencies() {
        ...
        ResponseDto<List<String>> response = new ResponseDto<>(HttpStatus.OK.value(), dependencies, "Lista de dependencias obtenida correctamente");
        return ResponseEntity.ok(response);
    }
